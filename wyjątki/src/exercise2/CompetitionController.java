...
public class CompetitionController {
    ...
    private void fillParticipantsInfo(Competition competition){
        while (competition.hasFreeSpots()){
            ...
            try {
                ...
                System.out.println("Uczeń o wskazanym identyfikatorze już istnieje."+e.getParticipant());
            }catch (MaxCompetitorsException e){
                System.out.println("Nie dodano uczestnika. maksymalna ilość."+e.getMaxCompetitors());
            }
        }
    }
    ...
    private Participant createParticipant(){
        ...
        System.out.println("Podaj id (pesel): ");
